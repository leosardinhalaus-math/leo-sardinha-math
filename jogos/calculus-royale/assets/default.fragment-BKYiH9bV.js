import{S as e}from"./index-Dwe0xGxe.js";import{s as ee,m as ie,d as te,a as oe,l as re}from"./logDepthDeclaration-BLlraO2u.js";import{h as ae}from"./helperFunctions-CRKUK89h.js";import{c as ne,a as le}from"./clipPlaneFragment-C_F8DG-m.js";import{f as se,a as fe}from"./fogFragment-AwJMaCFy.js";const t="decalFragmentDeclaration",P=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=P);const de={name:t,shader:P},o="defaultFragmentDeclaration",R=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=R);const ce={name:o,shader:R},r="objectIdFunctions",X=`highp vec4 encodeObjectId(highp float objectId) {
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=X);const ve={name:r,shader:X},a="prePassDeclaration",F=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=F);const he={name:a,shader:F},n="oitDeclaration",_=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=_);const ue={name:n,shader:_},l="lightFragmentDeclaration",N=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=N);const pe={name:l,shader:N},s="lightUboDeclaration",M=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=O);const ge={name:f,shader:O},d="clusteredLightingFunctions",y=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=y);const Se={name:d,shader:y},c="lightsFragmentFunctions",b=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=b);const Ee={name:c,shader:b},v="shadowsFragmentFunctions",U=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=U);const Te={name:v,shader:U},h="samplerFragmentDeclaration",H=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=H);const De={name:h,shader:H},u="fresnelFunction",W=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=W);const Ce={name:u,shader:W},p="reflectionFunction",G=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=G);const Ie={name:p,shader:G},m="imageProcessingDeclaration",z=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=z);const Le={name:m,shader:z},g="imageProcessingFunctions",V=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=V);const Ae={name:g,shader:V},S="textureRepetitionFunctions",B=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=B);const we={name:S,shader:B},E="bumpFragmentMainFunctions",k=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=k);const xe={name:E,shader:k},T="bumpFragmentFunctions",Y=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Y);const Pe={name:T,shader:Y},D="bumpFragment",$=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=$);const Re={name:D,shader:$},C="decalFragment",Z=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Z);const Xe={name:C,shader:Z},I="depthPrePass",j=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=j);const Fe={name:I,shader:j},L="lightFragment",q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=q);const _e={name:L,shader:q},A="logDepthFragment",Q=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Q);const Ne={name:A,shader:Q},w="oitFragment",J=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=J);const Me={name:w,shader:J},x="defaultPixelShader",K=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[x]||(e.ShadersStore[x]=K);const Oe=[de,ce,ee,ie,te,ve,he,ue,oe,ae,pe,me,ge,Se,Ee,Te,De,Ce,Ie,Le,Ae,we,xe,Pe,ne,re,se,le,Re,Xe,Fe,_e,Ne,fe,Me];for(const i of Oe)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ge={name:x,shader:K};export{Ge as defaultPixelShader};
