import{S as e}from"./index-D6xMpkCc.js";const r="morphTargetsVertexGlobalDeclaration",o=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=o);const x={name:r,shader:o},t="morphTargetsVertexDeclaration",d=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=d);const R={name:t,shader:d},n="morphTargetsVertexGlobal",f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=f);const m={name:n,shader:f},a="morphTargetsVertex",T=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=T);const s={name:a,shader:T};export{R as a,m as b,s as c,x as m};
