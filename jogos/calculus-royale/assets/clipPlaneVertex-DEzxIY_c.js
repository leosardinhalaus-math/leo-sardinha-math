import{S as e}from"./index-DK9Rv83A.js";const t="bonesDeclaration",m=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=m);const S={name:t,shader:m},i="bakedVertexAnimationDeclaration",o=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=o);const p={name:i,shader:o},n="clipPlaneVertexDeclaration",u=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=u);const v={name:n,shader:u},r="instancesDeclaration",l=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=l);const A={name:r,shader:l},a="instancesVertex",c=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=c);const T={name:a,shader:c},f="bonesVertex",I=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=I);const L={name:f,shader:I},s="bakedVertexAnimation",E=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=E);const V={name:s,shader:E},d="clipPlaneVertex",x=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=x);const _={name:d,shader:x};export{p as a,S as b,v as c,T as d,L as e,V as f,_ as g,A as i};
