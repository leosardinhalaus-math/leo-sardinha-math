import{S as e}from"./index-UBHrwkhK.js";import{s as J,m as K,d as ee,a as re,l as te}from"./logDepthDeclaration-DscvuNha.js";import{h as ae}from"./helperFunctions-_VSv_4dY.js";import{c as ie,a as oe}from"./clipPlaneFragment-B9p1Wxpo.js";import{f as fe,a as ne}from"./fogFragment-BSVjxz2I.js";const t="objectIdFunctions",A=`fn encodeObjectId(objectId: f32)->vec4f {
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=A);const se={name:t,shader:A},a="prePassDeclaration",P=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=P);const le={name:a,shader:P},i="oitDeclaration",X=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=X);const de={name:i,shader:X},o="lightUboDeclaration",_=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=_);const ce={name:o,shader:_},f="ltcHelperFunctions",R=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=R);const ve={name:f,shader:R},n="clusteredLightingFunctions",y=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=y);const ue={name:n,shader:y},s="clusteredLightingCompute",F=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=F);const pe={name:s,shader:F},l="lightsFragmentFunctions",N=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=N);const he={name:l,shader:N},d="shadowsFragmentFunctions",M=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=M);const me={name:d,shader:M},c="samplerFragmentDeclaration",O=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=O);const Se={name:c,shader:O},v="fresnelFunction",b=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=b);const ge={name:v,shader:b},u="reflectionFunction",W=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=W);const xe={name:u,shader:W},p="imageProcessingDeclaration",G=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=G);const Te={name:p,shader:G},h="imageProcessingFunctions",z=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=z);const Le={name:h,shader:z},m="textureRepetitionFunctions",U=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=U);const we={name:m,shader:U},S="bumpFragmentMainFunctions",H=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=H);const Ce={name:S,shader:H},g="bumpFragmentFunctions",V=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=V);const Ee={name:g,shader:V},x="bumpFragment",B=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=B);const Ie={name:x,shader:B},T="decalFragment",k=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=k);const De={name:T,shader:k},L="depthPrePass",Y=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=Y);const Ae={name:L,shader:Y},w="lightFragment",$=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=$);const Pe={name:w,shader:$},C="logDepthFragment",j=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=j);const Xe={name:C,shader:j},E="meshBlendTagFragmentOutput",q=`#if SCENE_MRT_COUNT>{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=q);const _e={name:E,shader:q},I="oitFragment",Z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=Z);const Re={name:I,shader:Z},D="defaultPixelShader",Q=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[D]||(e.ShadersStoreWGSL[D]=Q);const ye=[J,K,ee,se,le,de,re,ae,ce,ve,ue,pe,he,me,Se,ge,xe,Te,Le,we,Ce,Ee,ie,te,fe,oe,Ie,De,Ae,Pe,Xe,ne,_e,Re];for(const r of ye)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const We={name:D,shader:Q};export{We as defaultPixelShaderWGSL};
