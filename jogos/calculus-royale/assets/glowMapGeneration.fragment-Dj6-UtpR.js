import{S as e}from"./index-Dzftrxnb.js";import{h as f}from"./helperFunctions-DTeaPbuY.js";import{c as o,a as n}from"./clipPlaneFragment-z6dpcT2B.js";const i="glowMapGenerationPixelShader",r=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=r);const l=[f,o,n];for(const a of l)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const d={name:i,shader:r};export{d as glowMapGenerationPixelShaderWGSL};
